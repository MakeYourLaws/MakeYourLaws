class Initiative < ActiveRecord::Base
  ...
  attr_accessible :jurisdiction, :election_date, :filing_date, :summary_date, :circulation_deadline, :full_check_deadline, :election_type, :initiator_type, :initiative_type, :indirect, :initiative_name, :proposition_name, :title, :short_summary, :summary, :analysis, :text, :wikipedia_url, :ballotpedia_url # but not status
