class Payments::Paypal::Subtransaction < ActiveRecord::Base
  ...
  # TODO: check actual statuses for subs
  ...
  def update_from_hash hash
    # Example:
    # {"transactionId":"7GH50140BN703313B","transactionStatus":"COMPLETED",
    #   "receiver":
    #     {"amount":"10.50","email":"myla_1340554564_biz@saizai.com","primary":"false",
    #       "paymentType":"SERVICE"},
    #   "refundedAmount":"0.00","pendingRefund":"false","senderTransactionId":"0EK05781E1952545M",
    #   "senderTransactionStatus":"COMPLETED"
    # }
    self.sender_transaction_id = hash['senderTransactionId']
    self.receiver = hash['receiver']['email']
    # TODO: get currency from parent
    self.amount_cents = hash['receiver']['amount'].to_d * 100 rescue 0
    ...
    self.pending_refund = case hash['pendingRefund']
                            ...
                            when 'true' then true
                            else fail 'Unknown pendingRefund value'
                          end
    self
  end
end
