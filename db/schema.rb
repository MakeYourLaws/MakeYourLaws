...
ActiveRecord::Schema.define(version: 20150608134954) do
  ...
  create_table "fec_filing_f3", force: :cascade do |t|
    ...
    t.string   "candidate_name",                                    limit: 200
    t.string   "fec_record_type",                                   limit: 1,                            default: "C"
    t.decimal  "col_a_total_receipts_period",                                   precision: 12, scale: 2
    t.decimal  "col_a_subtotals",                                               precision: 12, scale: 2
  end
  ...
  add_index "fec_filing_f3z", ["authorized_committee_id_number"], name: "index_fec_filing_f3z_on_authorized_committee_id_number", using: :btree
  add_index "fec_filing_f3z", ["authorized_committee_name"], name: "index_fec_filing_f3z_on_authorized_committee_name", using: :btree
  ...
  add_index "fec_filing_sa3l", ["conduit_name"], name: "index_fec_filing_sa3l_on_conduit_name", using: :btree
  add_index "fec_filing_sa3l", ["donor_committee_name"], name: "index_fec_filing_sa3l_on_donor_committee_name", using: :btree
  add_index "fec_filing_sa3l", ["fec_record_type", "fec_record_number", "row_number"], name: "record_index", unique: true, using: :btree
